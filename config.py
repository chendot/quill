...
# Parameters
MAX_TOKENS = 2000
WRITER_EXAMPLES_MAX_CHARS = int(os.environ.get("WRITER_EXAMPLES_MAX_CHARS", "1400"))
ASSISTED_PRINT_MAX_CHARS = int(os.environ.get("ASSISTED_PRINT_MAX_CHARS", "1200"))
...
SCOUT_TOP_N = int(os.environ.get("SCOUT_TOP_N", "10"))
